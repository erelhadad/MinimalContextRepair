...
class WordContextPartitioner(BaseContextPartitioner):
    """
    Partitions context into tokenizer-word spans using HF tokenizer offsets.
    ...
    Note: This creates num_sources ~ number of words in context, which can be huge.
    """

    def __init__(self,context: str,tokenizer,ablate_mode: str = "blank",  # "blank" or "remove"
    ) -> None:
...
class TokenContextPartitioner(SimpleContextPartitioner):
        """
