...
from RagAdaptation.methods.adaptive_masking import mask_by_order_adaptive
from RagAdaptation.methods.at2 import AT2_ESTIMATOR_BY_MODEL
from RagAdaptation.methods.common import get_attention_scores, get_at2_token_scores, map_at2_scores_to_base_via_sources
...
def _finalize_method_result(*, method_name: str, out_dir: str, masked_logps, payload: Dict[str, Any]):
